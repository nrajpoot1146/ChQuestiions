...
#define checkException(CALL){testNumber++;bool exceptionRaised = false;try{CALL;}catch(DiyVector<int>::OutOfRange& o){exceptionRaised = true;}if ( !exceptionRaised ) throw TestFailed(testNumber);}
